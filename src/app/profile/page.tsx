...
export const metadata: Metadata = {
  ...
  description: "Perfil André Lucas Trevizan | Daly Games"
}
      ...
      <Container>
        ...
        >
          <div className="w-full flex items-center gap-4 text-lg flex-col sm:flex-row justify-center sm:justify-normal">
            ...
            />
            <h1 className="font-bold text-2xl">André Lucas Trevizan</h1>
          </div>
        ...
        <section
          className="flex flex-wrap gap-5 flex-col md:flex-row"
        >
